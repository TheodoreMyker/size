...
function TikTok() {
    setTimeout(function() {
            window.open('https://www.tiktok.com/@nastank10', 'ultimate')
        },
        100);
}
...
function Facebook() {
    setTimeout(function() {
            window.open('https://www.facebook.com/anyblanguyen', 'ultimate')
        },
        100);
}
...
function Github() {
    setTimeout(function() {
            window.open('https://github.com/AnyBlaNguyen', 'ultimate')
        },
        100);
}
